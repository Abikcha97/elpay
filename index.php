...
<body id="home" class="tm-isblog">
	...
	<a href="tel:+99875 220-03-03"><i class="uk-icon-phone-square"></i> +99875 220-03-03</a>
...
<li><a  class="uk-active"  href="contacts.php"><?php echo $Lang['contact']; ?></a></li>
  ...
  <a href="index.php" class="uk-slidenav uk-slidenav-contrast uk-slidenav-next" data-uk-slideshow-item="next"></a>
	...
	<div class="uk-panel" >
		...
		<li><a href="#top-c" class="scroll"><?php echo $Lang['services']; ?></a></li>
	...
	<div class="uk-panel uk-panel-box uk-text-center" data-uk-scrollspy="{cls:'',delay:800}">
			<span class="uk-icon-mobile-phone uk-icon-medium"></span>
			<h3><?php echo $Lang['elpay_mobile_comment']; ?></h3>
			<p><?php echo $Lang['elpay_mobile_comment2']; ?></p>
<!-- This is a button toggling the modal -->
	...
	<div class="uk-width-1-1 uk-width-medium-1-3">
	<div class="uk-panel uk-panel-box uk-panel-box-primary uk-text-center" data-uk-scrollspy="{cls:'',delay:800}">
			<span class="uk-icon-gears uk-icon-medium"></span>
			<h3><?php echo $Lang['o_s']; ?></h3>
			<?php echo $Lang['o_services_comment']; ?>
<!-- This is a button toggling the modal -->
		<a class="uk-margin-large-top uk-button uk-button-secondary" href="#my-id2" data-uk-modal="{center:true}"><?php echo $Lang['r_m']; ?></a>
...
<div id="my-id2" class="uk-modal">
    <div class="uk-modal-dialog">
        <a class="uk-modal-close uk-close"></a>
        <h3><?php echo $Lang['o_s']; ?></h3>
       <?php echo $Lang['o_services_comment_1']; ?>
    </div>
</div>
<!-- This is the modal -->
<!-- <div id="my-id" class="uk-modal">
    <div class="uk-modal-dialog">
        <a class="uk-modal-close uk-close"></a>
        <h3></h3>
       <p>  <a class="uk-margin-large-top uk-button uk-button-secondary" href="#" data-uk-modal="{center:true}">Sample Modal Box</a>
</p>
    </div>
</div> --></div></div>
	...
	<div class="uk-panel uk-panel-box uk-text-center" data-uk-scrollspy="{cls:'',delay:800}">
      ...
      <br>
<!-- This is a button toggling the modal -->
			<a class="uk-margin-large-top uk-button uk-button-secondary" href="#my-id3" data-uk-modal="{center:true}"><?php echo $Lang['r_m']; ?></a>
			<div id="my-id3" class="uk-modal">
    <div class="uk-modal-dialog">
        <a class="uk-modal-close uk-close"></a>
        <?php echo $Lang['elpay_terminal_comment']; ?>
       <p><img src="images/terminal.png" width="60px" height="200px"></p></p>
    </div>
</div>
			</section></div></div>
	...
	<div class="sprocket-tables-desc sprocket-tables-cell sprocket-tables-bg1">
			...
			<a href="#"><?php echo $Lang['elpay_mobile_comment']; ?></a></h4>
...
<div id="my-id5" class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <h2><p><mark><?php echo $Lang['sorry']; ?> </mark></p></h2></div></div>
			...
			<li><a href="about.php"><?php echo $Lang['aboute_us']; ?></a></li></ul></div><div class="uk-panel" ><div class="footer1">Copyright &#169; 2020 "ElPay" MCHJ</div>
							 </div>
	<div class="uk-panel" >
