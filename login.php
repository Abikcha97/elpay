<?php 
session_start();
$_SESSION['older_path'] = $_SESSION['path'];
...
<script src="https://www.google.com/recaptcha/api.js?render=6LcjHeIUAAAAACKcYKJcdi1W74eZmkCfiuYJqnbs"></script>
<script>
grecaptcha.ready(function() {
    grecaptcha.execute('6LcjHeIUAAAAACKcYKJcdi1W74eZmkCfiuYJqnbs', {action: 'login.php'}).then(function(token) {
       ...
    });
});
</script>
...
<a href="index.php"><i class="uk-icon-button uk-icon-google-plus"></i></a></div></div> -->
	...
	<div class="menu-style"><ul class="uk-navbar-nav uk-hidden-small">
		<li><a href="index.php"><i class="uk-icon-home"></i></i><?php echo $Lang['home']; ?></a></li>
		<li class="uk-parent" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="#"></i><?php echo $Lang['services']; ?></a>
	...
	<div class="uk-grid uk-dropdown-grid"><div class="uk-width-1-2"><ul class="uk-nav uk-nav-navbar">
		<li><a href="#"></i><?php echo $Lang['ser_name_1']; ?></a></li>
		<li><a href="#"></i><?php echo $Lang['ser_name_2']; ?></a></li>
		<li><a href="#"></i><?php echo $Lang['ser_name_3']; ?></a></li></ul></div>
	<div class="uk-width-1-2"><ul class="uk-nav uk-nav-navbar">
		<li><a href="#"></i><?php echo $Lang['ser_name_4']; ?></a></li>
		<li><a href="#"></i><?php echo $Lang['ser_name_5']; ?></a></li>
		<li><a href="#"></i><?php echo $Lang['ser_name_6']; ?></a></li></ul></div></div></div></li>

		<li class="uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="#"></i><?php echo $Lang['my_cabinet']; ?></a>
    <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
    <div class="uk-grid uk-dropdown-grid">
    <div class="uk-width-1-1"><ul class="uk-nav uk-nav-navbar">
    	<li class="uk-parent"><a href="register.php"></i><?php echo $Lang['reg']; ?></a></li>
    	<li class="uk-active"><a href="login.php"></i><?php echo $Lang['log']; ?></a></li></ul></div></div></div></li>

    	<li class="uk-parent" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="#"></i><?php echo $Lang['news']; ?></a>
    <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
    <div class="uk-grid uk-dropdown-grid">
    <div class="uk-width-1-1"><ul class="uk-nav uk-nav-navbar">
    	<li><a href="our_news.php"></i><?php echo $Lang['o_n']; ?></a></li>
    	<li><a href="it_news.php"></i><?php echo $Lang['t_n']; ?></a></li>
    	</ul></div></div></div></li>

    	<li class="uk-parent" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="#"></i><?php echo $Lang['help']; ?></a>
    <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
    <div class="uk-grid uk-dropdown-grid">
    <div class="uk-width-1-1"><ul class="uk-nav uk-nav-navbar">
<li class="uk-parent"><a href="about.php"></i><?php echo $Lang['aboute_us']; ?></a>
  <li><a class="uk-button-secondary" href="#partners" data-uk-modal="{center:true}"></i><?php echo $Lang['o_partner']; ?></a>
    <div id="partners" class="uk-modal">
    <div class="uk-modal-dialog">
          <a class="uk-modal-close uk-close"></a>
          <p><table border="2" align="center" width="100%" ccellspacing="0" cellpadding="5" class="pts">
<thead align="center">
<caption><h2></i><?php echo $Lang['partners']; ?></h2></caption>
<colgroup width="40%"></colgroup>
<colgroup span="2"><col width="20%"><col width="10%"></colgroup>
<tr bgcolor="orange">
<th width="50" align="center"> </i><?php echo $Lang['partners']; ?></th>
<th width="70" align="center"></i><?php echo $Lang['phone_number']; ?></th>
<th width="70" align="center"></i><?php echo $Lang['web_site']; ?></th>
</tr>
</thead>
<tbody align="center">
<tr bgcolor="#0093d3">
...
<tbody align="center">
<tr bgcolor="#0093d3">
<td></i><?php echo $Lang['turon_bank']; ?></td>
...
<tbody align="center">
<tr bgcolor="#0093d3">
<td></i><?php echo $Lang['xalq_bank']; ?></td>
...
<tbody align="center">
<tr bgcolor="#0093d3">
<td></i><?php echo $Lang['and_other_bank']; ?></td>
<td>-</td>
<td>-</td>
</tr>
</tbody>
</table></p></div></div></li>
<li><a  class="uk-active"  href="contacts.php"></i><?php echo $Lang['contact']; ?></a></li>
  <li><a  class="uk-active"  href="instruments.php"></i><?php echo $Lang['software']; ?></a></li>
      </ul></div></div></div></li>
    ...
    <div class="uk-text-center uk-align-center">
			<h1></i><?php echo $Lang['comment_elpay']; ?></h1>
			<h4></i><?php echo $Lang['comment_elpay2']; ?> </h4>
			<p><a class="uk-button" href="about.php"></i><?php echo $Lang['r_m_...']; ?></a></p></div></div></li>
    ...
    <div class="uk-text-center uk-align-center">
			<h1></i><?php echo $Lang['comment_elpay']; ?></h1>
			<h4></i><?php echo $Lang['comment_elpay2']; ?>.</h4>
			<p><a class="uk-button" href="about.php"></i><?php echo $Lang['r_m_...']; ?></a></p></div></div></li></ul>
  ...
  <a href="index.php" class="uk-slidenav uk-slidenav-contrast uk-slidenav-next" data-uk-slideshow-item="next"></a>
	...
	<div class="uk-panel" >
		...
		<li><a href="#top-c" class="scroll"><?php echo $Lang['logincha']; ?></a></li>
...
<div class="registration">
	<div class="form">
	<form method="post" action="registration/authentification.php">
		<p><?php echo $Lang['logincha']; ?></p>
<div class="field-wrapcha">
            <label><?php echo $Lang['emailcha']; ?><span class="req">*</span>
            </label><br><br>
            <input style="height: 45px" type="email" name="login" placeholder=<?php echo $Lang['emailcha']; ?> required>
          </div>

	 <div class="field-wrapcha">
            <label>
              <?php echo $Lang['passwordcha']; ?><span class="req">*</span>
            </label><br><br>
            <input style="height: 45px" type="password" name="password" placeholder=<?php echo $Lang['passwordcha']; ?> required>
          </div>
	<button type="submit" name="signIn" id="sub"><?php echo $Lang['logincha']; ?></button>
	<div class="text-foot"> <?php echo $Lang['registercha_?']; ?> <a href="Register.php"><?php echo $Lang['reg']; ?></a></div>
	...
	<div class="sprocket-tables-link sprocket-tables-cell sprocket-tables-bg1">
			<a  class="uk-margin-large-top uk-button uk-button-secondary" href="#my-id4" data-uk-modal="{center:true}"></i><?php echo $Lang['r_m_...']; ?></a>
...
<div id="my-new3" class="uk-modal">
	...
	<div class="uk-panel" data-uk-scrollspy="{cls:'',delay:800}">
			...
			<i class="uk-icon-road"></i> <?php echo $Lang['address_name']; ?></br>
...
<div class="uk-width-1-1 uk-width-medium-1-3">
	<div class="uk-panel" data-uk-scrollspy="{cls:'',delay:800}">
			...
			<h5><?php echo $Lang['top_news_1']; ?> <a class="uk-margin-large-top uk-button-secondary" href="#my-neww1" data-uk-modal="{center:true}"></i><?php echo $Lang['r_m_...']; ?></a></p>
			<hr class="dark"/>
			<h5><?php echo $Lang['top_news_title']; ?></h5>
			<p><?php echo $Lang['top_news_2']; ?><a class="uk-margin-large-top uk-button-secondary" href="#my-new3" data-uk-modal="{center:true}"> </i><?php echo $Lang['r_m_...']; ?></a></p>
			<hr class="dark"/>
</div></div>
	...
	<div class="uk-panel" >
		<ul class="uk-subnav uk-subnav-line">
			...
			<li><a href="#"><?php echo $Lang['news']; ?></a></li></ul></div><div class="uk-panel" ><div class="footer1">Copyright &#169; 2020 <?php echo $Lang['footer_comp_name']; ?></div>
							 </div>
	<div class="uk-panel" >
	...
	<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
		...
		<ul class="uk-nav-sub"><li><a href=""><?php echo $Lang['ser_name_1']; ?></a></li>
			...
			<li class="uk-parent"><a href="#"><?php echo $Lang['my_cabinet']; ?></a>
		<ul class="uk-nav-sub">
			<li><a href="register.php"><?php echo $Lang['reg']; ?></a></li>
			<li><a href="login.php"><?php echo $Lang['log']; ?></a></li></ul>
