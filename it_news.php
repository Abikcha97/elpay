...
<div class="sprocket-tables-link sprocket-tables-cell sprocket-tables-bg1">
	...
	<div class="sprocket-tables-block" data-tables-item>
	<div class="sprocket-tables-item" data-tables-content>
			<img src="images/news2.jpg" class="sprocket-tables-image" alt="image" />
	<div class="sprocket-tables-desc sprocket-tables-cell sprocket-tables-bg1">
			<h4 class="sprocket-tables-title" data-tables-toggler>
			<a  href="#my-new2" data-uk-modal="{center:true}">	<?php echo $Lang['n_name_1']; ?></a></h4>
			<span class="sprocket-tables-text"><?php echo $Lang['top_news_title']; ?></span></div>


			<span class="sprocket-tables-price sprocket-tables-cell sprocket-tables-bg2"> START-UP</span>
			<span class="sprocket-tables-feature sprocket-tables-cell sprocket-tables-bg1">
			<?php echo $Lang['news_com_key_1']; ?></span>
    ...
    <div class="uk-modal-dialog">
        ...
        <h3>START-UP</h3>
       <p>
		<?php echo $Lang['news_text_1']; ?>
       <p><img src="images/news2.jpg" width="100px" height="100px"></p></p>
    </div>
</div>
			 </div></div></div>
	...
	<div class="sprocket-tables-desc sprocket-tables-cell sprocket-tables-bg1">
			<h4 class="sprocket-tables-title" data-tables-toggler>
			<a href="#"><?php echo $Lang['n_name_2']; ?>	</a></h4>
