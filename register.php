...
<a href="index.php"><i class="uk-icon-button uk-icon-google-plus"></i></a></div></div> -->
    ...
    <div class="uk-modal-dialog">
		...
		<li class="uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="#"><?php echo $Lang['my_cabinet']; ?></a>
    <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
    <div class="uk-grid uk-dropdown-grid">
    <div class="uk-width-1-1"><ul class="uk-nav uk-nav-navbar">
    	<li><a href="register.php"><?php echo $Lang['reg']; ?></a></li>
    	<li><a href="login.php"><?php echo $Lang['log']; ?></a></li></ul></div></div></div></li>
...
<li><a  class="uk-active"  href="contacts.php"><?php echo $Lang['contact']; ?></a></li>
  <li><a  class="uk-active"  href="instruments.php"><?php echo $Lang['software']; ?></a></li>
    ...
    <div class="uk-text-center uk-align-center">
			...
			<p><a class="uk-button" href="about us.html"><?php echo $Lang['r_m_...']; ?></a></p></div></div></li>
    ...
    <div class="uk-text-center uk-align-center">
			<h1><?php echo $Lang['comment_elpay']; ?></h1>
			<h4><?php echo $Lang['comment_elpay2']; ?></h4>
			<p><a class="uk-button" href="about us.html"><?php echo $Lang['r_m_...']; ?></a></p></div></div></li></ul>
  ...
  <a href="index.php" class="uk-slidenav uk-slidenav-contrast uk-slidenav-next" data-uk-slideshow-item="next"></a>
	...
	<div class="uk-panel" >
		...
		<li><a href="#top-c" class="scroll"><?php echo $Lang['reg']; ?></a></li>
...
<div class="registration">
	<div class="form">
	<form method="post" action="registration/verify_and_send.php" id="registration">

<div class="top-rowcha">
            <div class="field-wrapcha">
              <label>
               <?php echo $Lang['namecha']; ?><span class="req">*</span>
              </label><br><br>
              <input style="height: 45px" type="text"  name="name" placeholder=<?php echo $Lang['namecha']; ?>>
            </div>

<div class="field-wrapcha">
              <label>
                <?php echo $Lang['first_namecha']; ?><span class="req">*</span>
              </label><br><br>
              <input style="height: 45px" type="text" name="surname" placeholder=<?php echo $Lang['first_namecha']; ?>>
            </div>
          </div>

	<div class="field-wrapcha">
          <label>
         <?php echo $Lang['pnumber']; ?><span class="req">*</span></label><br><br> 
            <input style="height: 45px; width: 30px;" type="text"  disabled placeholder="+"><input style="width: 94%; height: 45px;"  name="phone" required="" type="text"> </div>

	<div class="field-wrapcha">
            <label><?php echo $Lang['emailcha']; ?><span class="req">*</span>
            </label><br><br>
            <input style="height: 45px" type="email" name="login" placeholder=<?php echo $Lang['emailcha']; ?>>
          </div>
	 ...
	 <div class="field-wrapcha">
            ...
            <input style="height: 45px" type="password" name="password" placeholder=<?php echo $Lang['passwordcha']; ?>>
          </div>
	
	<div class="g-recaptcha" data-sitekey="6Lfs3OMUAAAAABqr5OX_gixtaaIEtRLK57FONKv8"></div>
      <br/>
	
<button type="submit" id="sub"> <?php echo $Lang['reg']; ?></button></li>
	</form>
	
</div><script src="https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit"
    async defer>
</script></div></div>
	...
	<div class="sprocket-tables-desc sprocket-tables-cell sprocket-tables-bg1">
			...
			<a href="#"><?php echo $Lang['n_name_3']; ?></a></h4>
...
<div id="my-new3" class="uk-modal">
	...
	<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
		...
		<ul class="uk-nav-sub"><li><a href=""><?php echo $Lang['ser_name_1']; ?></a></li>
			...
			<li class="uk-active"><a href="#"><?php echo $Lang['my_cabinet']; ?></a>
		<ul class="uk-nav-sub">
			<li><a href="register.php"><?php echo $Lang['reg']; ?></a></li>
		...
		<ul class="uk-nav-sub">
			<li class="uk-parent"><a href="about us.html"><?php echo $Lang['aboute_us']; ?></a></li>
			<li><a href="#partners" data-uk-modal="{center:true}">Bizning Hamkorlar</a></li>
