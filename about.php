...
<a href="index.php"><i class="uk-icon-button uk-icon-google-plus"></i></a></div></div> -->
	...
	<div class="menu-style"><ul class="uk-navbar-nav uk-hidden-small">
		<li><a href="index.php"><i class="uk-icon-home"></i><?php echo $Lang['home']; ?></a></li>
...
if( !(isset($_SESSION['user_name'])&&isset($_SESSION['user_surname']))){
    ...
    <div class=\"uk-width-1-1\"><ul class=\"uk-nav uk-nav-navbar\">
    	<li class=\"uk-parent\"><a href=\"register.php\">".$Lang['reg']."</a></li>
...
?>
    ...
    <div class="uk-grid uk-dropdown-grid">
    <div class="uk-width-1-1"><ul class="uk-nav uk-nav-navbar">
<li class="uk-parent"><a href="about us.html"><?php echo $Lang['aboute_us']; ?></a>
...
<li><a  class="uk-active"  href="contacts.php"><?php echo $Lang['contact']; ?></a></li>
  ...
  <a href="index.php" class="uk-slidenav uk-slidenav-contrast uk-slidenav-next" data-uk-slideshow-item="next"></a>
	...
	<div class="uk-panel" >
		...
		<li><a href="#top-c" class="scroll"><?php echo $Lang['aboute_us']; ?></a></li>
...
<div class="About">
	<h2><?php echo $Lang['about_elpay_llc']; ?></h2>
	<p class="about-us"><?php echo $Lang['about_text']; ?></p>
</div></div>
...
if( !(isset($_SESSION['user_name'])&&isset($_SESSION['user_surname']))){
		...
		<ul class=\"uk-nav-sub\"><li uk-parent><a href=\"register.php\">".$Lang['reg']."</a></li>
