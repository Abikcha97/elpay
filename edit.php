...
<div class="registration">
	<div class="form">
<form method="post" action="registration/edit_profil.php" id="registration">
<h2>Edit Profil</h2>	
...
<div class="field-wrapcha">
	...
	<div class="field-wrapcha">
         ...
         <?php echo $Lang['pnumber']; ?><span class="req">*</span></label><br><br> 
            <input style="height: 45px; width: 30px;" type="text"  disabled placeholder="+"><input type="number"  name="phone" value=<?php echo $_SESSION['user_phone']; ?> > </div>
	 ...
	 <div class="field-wrapcha">
            ...
            <input type="password" name="password"  placeholder=<?php echo $Lang['passwordcha']; ?>></div>

<div class="field-wrapcha">
            <label>
              <?php echo $Lang['n_pass']; ?><span class="req">*</span>
            </label><br><br>
	<input type="password" name="new_password"  placeholder=<?php echo $Lang['n_pass']; ?>></div>

<div class="field-wrapcha">
            <label>
              <?php echo $Lang['r_n_pass']; ?><span class="req">*</span>
            </label><br><br>
	<input type="password" name="new_password2"  placeholder=<?php echo $Lang['r_n_pass']; ?>><br><br>>
          </div><

	<button type="submit" id="sub"> <?php echo $Lang['log']; ?></button>
