...
?>
    	...
    	<li class="uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="#"><?php echo $Lang['news']; ?></a>
    <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
    <div class="uk-grid uk-dropdown-grid">
    <div class="uk-width-1-1"><ul class="uk-nav uk-nav-navbar">
...
<div class="sprocket-tables-link sprocket-tables-cell sprocket-tables-bg1">
	...
	<div class="sprocket-tables-block" data-tables-item>
	<div class="sprocket-tables-item" data-tables-content>
			<img src="images/Logo.png" width="300px" height="300px" class="sprocket-tables-image" alt="image" />
	<div class="sprocket-tables-desc sprocket-tables-cell sprocket-tables-bg1">
			<h4 class="sprocket-tables-title" data-tables-toggler>
			<a  href="#my-new2" data-uk-modal="{center:true}"><?php echo $Lang['n_name_4']; ?></a></h4>
			<span class="sprocket-tables-text"><?php echo $Lang['o_n']; ?></span></div>


			<span class="sprocket-tables-price sprocket-tables-cell sprocket-tables-bg2"><?php echo $Lang['n_name_4']; ?></span>
			<span class="sprocket-tables-feature sprocket-tables-cell sprocket-tables-bg1">
			<?php echo $Lang['news_com_key_4']; ?></span>
			
	<div class="sprocket-tables-link sprocket-tables-cell sprocket-tables-bg1">
			<a  class="uk-margin-large-top uk-button uk-button-secondary" href="#my-new2" data-uk-modal="{center:true}"><?php echo $Lang['r_m_...']; ?></a>
			<div id="my-new2" class="uk-modal">
    <div class="uk-modal-dialog">
        <a class="uk-modal-close uk-close"></a>
        <h3><?php echo $Lang['n_name_4']; ?></h3>
       <p><?php echo $Lang['news_text_4']; ?>
       <p><img src="images/Logo.png" width="100px" height="100px"></p></p>
    </div>
</div>
			 </div></div></div>
	...
	<div class="sprocket-tables-block" data-tables-item>
	<div class="sprocket-tables-item" data-tables-content>
			<img src="images/terminal.png" width="150px" height="250px" class="sprocket-tables-image" alt="image" />
	<div class="sprocket-tables-desc sprocket-tables-cell sprocket-tables-bg1">
			<h4 class="sprocket-tables-title" data-tables-toggler>
			<a href="http://www.prommax.uz"><?php echo $Lang['n_name_5']; ?></a></h4>
			<span class="sprocket-tables-text"> <?php echo $Lang['o_n']; ?></span></div>
			
			<span class="sprocket-tables-price sprocket-tables-cell sprocket-tables-bg2"> 
      <!-- Katta shrift bo'lib ketgan yozuv -->
        <!-- <?php echo $Lang['elpay_terminal_comment']; ?> --> 

      </span>
			<span class="sprocket-tables-feature sprocket-tables-cell sprocket-tables-bg1">
				<?php echo $Lang['news_com_key_5']; ?></span>
	<div class="sprocket-tables-link sprocket-tables-cell sprocket-tables-bg1">
...
<div id="my-new3" class="uk-modal">
    <div class="uk-modal-dialog">
        <a class="uk-modal-close uk-close"></a>
        <?php echo $Lang['news_text_5']; ?>
       <p><img src="images/EKRAN.jpg" width="100px" height="100px"><img src="images/ehtiyot qismlari.jpg" width="100px" height="100px"><img src="images/VALIDATOR 2.jpg" width="100px" height="100px"><img src="images/PROTSESSOR.jpg" width="100px" height="100px">
       	<img src="images/ichki tuzilishi.jpg" width="100px" height="100px"></p></p>
    </div>
</div>
...
<div id="my-id5" class="uk-modal">
	...
	<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
		...
		<ul class="uk-nav-sub">
			<li><a href="#my-id5" data-uk-modal="{center:true}"><?php echo $Lang['ser_name_1']; ?></a></li>
