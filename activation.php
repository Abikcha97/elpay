...
<div class="rlform rlform-wrapper">
	...
	<form method="post" action="registration/registration.php">
            ...
            <label><?php echo $Lang['act_code']; ?><span class="req">*</span>
            </label><br><br>
	<input style="height: 45px" type="number" name="code"></div>
	<div class="rlform-group" align="center">
	<button type="submit" name="signIn"><?php echo $Lang['activate']; ?></button>
